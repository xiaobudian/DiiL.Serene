...
{
    [Migration(20160603113000)]
    public class AocDB_20160603_113000_Permissions : AutoReversingMigration
    {
        public override void Up()
        {
            Create.Table("UserPermissions")
                ...
                .WithColumn("Grant").AsBoolean().WithDefaultValue(true).NotNullable()
