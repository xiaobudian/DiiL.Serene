...
namespace DiiL.Serene.Aoc.Entities
{
    ...
    public sealed class SnRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Generate Task"), Column("generateTaskId"),
            NotNull, ForeignKey("[dbo].[SNGenerate]", "id"), LeftJoin("jGenerateTask"),
            TextualField("GenerateTaskPrefix")]
        ...
        [DisplayName("Product Version Id"), Column("productVersionId"),
            NotNull, ForeignKey("[dbo].[ProductVersion]", "id"), LeftJoin("jProductVersion")]
        ...
        [DisplayName("型号"), Expression("jProductVersion.Name"), QuickSearch]
        ...
        [DisplayName("Sn Prefix"), Column("snPrefix"), Size(16), QuickSearch]
